...
{
  public:
    Tracer() : auto_play_enabled(false), auto_play_interval_ms(500) {}

    void start()
    {
        common::log() << "Starting run" << '\n';
        {
    ...
    void signal_and_wait(PayloadT payload)
    {
        ...
        {
            common::log() << "Signaling ready to step..." << '\n';
    ...
    void start_auto_play(uint32_t interval_ms = 500)
    {
        ...
        common::log() << "Auto-play started (interval: " << interval_ms << "ms)" << '\n';
    }

    void stop_auto_play()
    {
        auto_play_enabled = false;
        common::log() << "Auto-play stopped" << '\n';
    }

    void set_auto_play_speed(uint32_t interval_ms)
    {
        auto_play_interval_ms = interval_ms;
        common::log() << "Auto-play speed changed to " << interval_ms << "ms" << '\n';
    }
