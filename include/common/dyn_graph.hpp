#ifndef GPUSSSP_COMMON_DYN_GRAPH_HPP
#define GPUSSSP_COMMON_DYN_GRAPH_HPP
  ...
  public:
    ...
    edge_id_t insert(const edge_t &e)
    {
        ...
        else
        {
            ...
            // relocate block
            std::copy(targets.begin() + old_begin,
                      targets.begin() + old_end,
                      std::back_inserter(targets));
            std::copy(weights.begin() + old_begin,
                      weights.begin() + old_end,
